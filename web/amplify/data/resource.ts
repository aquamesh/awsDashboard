...
const schema = a
  .schema({
    ...
    // User Settings model (with owner-based access)
    UserSettings: a.model({
      id: a.id(), // Auto-generated by Amplify
      theme: a.string(), // e.g. "light" or "dark"
      uiLayout: a.json(), // Flexible structure for storing user UI preferences
    }),
  })
  .authorization((allow) => [
    allow.authenticated(),
    allow.resource(sendSensorValue),
    allow.owner(), // Secure UserSettings records to their Cognito owner
  ]);
